...
def load_metrics(custom_metric_script_path, base_metric_script_path, target_subchain, target_blockchain, config):
    ...
    def load_metric_classes(type_, script_path, metric_base_class, target_subchain=target_subchain,
                            target_blockchain=target_blockchain):  # TODO: add blockain name and subchain name
    ...
    base_metric_instances = load_metric_classes('basic', base_metric_script_path, BaseMetric)
