...
CREATE TABLE IF NOT EXISTS transaction_data (
    ...
    function_signature VARCHAR(64),
    input_data TEXT,
    output_data TEXT,
    proposal_id VARCHAR(64),
    vote_option VARCHAR(64),
    voting_power NUMERIC,
    is_private BOOLEAN,
    privacy_type VARCHAR(64),
    fee_amount NUMERIC,
    fee_token VARCHAR(64),
    sender_address VARCHAR(64),
    recipient_address VARCHAR(64),
    block_producer VARCHAR(64),
    block_producer_reward NUMERIC,
    amount_unlocked NUMERIC,
